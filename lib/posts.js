...
export async function getSortedQAList(){
    const resp = await axios.get('https://oucrc-qbox.vercel.app/api/qas');
    return resp.data;
}
...
export async function getSessionData(id){
    ...
    const resp = await axios.get('https://oucrc-qbox.vercel.app/api/session', {params: {id: idh}});
    return resp.data;
}

export async function deleteSession(id){
    await axios.delete('https://oucrc-qbox.vercel.app/api/session', {params: {id: id}});
}
