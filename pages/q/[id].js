        ...
        return (
            <Layout sid={sid}>
                <Head>
                    ...
                    <meta property='og:image' content={"/api/ogp?text=" + encodeURI(qaData.question)} />
                    <meta name="twitter:card" content="summary_large_image" />
                    <meta name='twitter:title' content='岡大電算研質問箱' />
                    <meta name='twitter:description' content='岡大電算研（OUCRC）が質問に回答しました。' />
                </Head>
                <h2>質問</h2>
                <QSheet text={qaData.question} />
                （{qaData.date}）
                <h2>回答</h2>
